...
<template>
  <section id="about" class="mt-[11.5rem]">
    ...
    <div class="gap-12 grid grid-cols-1 antialiased lg:gap-10 lg:grid-cols-[1fr_1fr_1fr]">
      <img
        src="https://i.imgur.com/SOgRbCo.png"
      ...
      <div>
        ...
        <p class="text-[24px] leading-[28.8px] tracking-[-0.48px] font-500 mt-[10px]">
        ...
        <button class="text-[16px] text-[#1a1a1a] leading-[19.2px] tracking-[-0.48px] font-500 mt-9 px-6 py-3 rounded-[4px] bg-text transition-all duration-250 hover:bg-[#f6f4f0] active:scale-[0.985]">
          download resume
        </button>
      </div>
      <div>
