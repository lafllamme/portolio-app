      ...
      <div class="flex items-end justify-between">
        <div class="grid overflow-hidden">
          <p
            ...
            class="text-[28px] text-text leading-none tracking-[-0.055em] font-500 transition-opacity duration-300 [grid-area:1/1]"
            :class="activeIndex === index ? 'opacity-100' : 'opacity-0 pointer-events-none'"
          >
            {{ timelineYear.year }}
          </p>
        </div>
        <p class="text-[11px] text-text/55 leading-none tracking-[0.08em] font-500 uppercase">
      ...
      <div class="divide-line divide-y">
        ...
        >
          <div class="self-stretch">
            <article class="top-[9rem] sticky md:py-[4vh] md:top-[10vh]">
              <div class="max-w-[56rem]">
                <div class="mb-8 flex items-center justify-between md:mb-12">
                  <p class="text-[12px] text-muted/60 leading-none tracking-[0.08em] font-500 uppercase">
                    chapter {{ (groupIndex + 1).toString().padStart(2, '0') }}
                  </p>
                  <p class="text-[13px] text-text leading-none tracking-[0.04em] font-500 uppercase md:hidden">
                    {{ group.item.period }}
                  </p>
                </div>
                ...
                <p class="text-[23px] text-text/76 leading-[1.28] tracking-[-0.03em] mt-12 max-w-[54rem] md:text-[30px]">
                  {{ group.item.summary }}
                </p>
              </div>
            </article>
      ...
      <aside class="pb-[16vh] pt-[10vh] min-h-[80vh] hidden top-[10vh] sticky md:flex md:flex-col md:justify-between">
        <div class="grid overflow-hidden">
          <p
            ...
            class="text-[clamp(3.2rem,4.8vw,5.5rem)] text-text leading-[0.88] tracking-[-0.075em] font-500 whitespace-nowrap transition-opacity duration-300 [grid-area:1/1]"
            :class="activeIndex === index ? 'opacity-100' : 'opacity-0 pointer-events-none'"
          >
            {{ timelineYear.year }}
          </p>
        ...
        <div class="space-y-5">
          ...
          <div class="text-[12px] text-text/55 leading-none tracking-[0.08em] font-500 flex uppercase justify-between">
