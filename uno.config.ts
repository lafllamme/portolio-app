...
export default defineConfig({
  ...
  rules: [
    ...
    ['about-intro-reveal-ready', {
      'animation': 'about-intro-reveal 920ms cubic-bezier(0.2,0.95,0.34,1) 380ms both',
      'opacity': '0',
      'will-change': 'transform, opacity',
    }],
    ['work-card-enter', {
  ...
  theme: {
    ...
    animation: {
      keyframes: {
        ...
        'about-intro-reveal':
          '{from{transform:translate3d(0,84px,0);opacity:0}to{transform:translate3d(0,0,0);opacity:1}}',
        'work-card-enter':
